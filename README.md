...
> *Un paseo tranquilo por un mundo vivo y lleno de vida.*

**Raíces Errantes** es un proyecto de exploración en Unity donde recorres libremente un entorno natural lleno de detalles. Sin objetivos ni prisas — solo camina y descubre lo que el bosque tiene para ofrecerte.
...
- **Big Oak Tree FREE**
- Git LFS para el manejo de assets pesados
...
1. Clona el repositorio:
   ```bash
   git clone https://github.com/tatifonseca06/UnityObjects.git
   ```
2. Abre el proyecto en **Unity 2021.3+**
3. Abre cualquier escena desde `Assets/Scenes/`
4. Dale **Play** y empieza a explorar 🌲
